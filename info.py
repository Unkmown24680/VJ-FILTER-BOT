...
# Bot information
SESSION = environ.get('SESSION', 'unknown')
API_ID = int(environ.get('API_ID', '23576751'))
API_HASH = environ.get('API_HASH', '5224da0df5c60ec53de09ce79b9aa2c3)
BOT_TOKEN = environ.get('BOT_TOKEN', "6366786954:AAH4ywjnKH8-dyiqW4_JA0kO3noKIlK4Ats")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002033273853)
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6642501643').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002081084874) # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002081084874')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kefobi2259:RWxEMTIGj5Bc1Hz6@cluster0.bbn7aup.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'itz_me_unknown01') # owner username without @
